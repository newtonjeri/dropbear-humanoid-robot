...
class HandJTCPublisher(Node):
    ...
    def __init__(self):
        ...
        if self.leg == 'right':
            ...
            self.get_logger().info("Controlled Joints: RH_pitch, RH_roll, RH_elbow_joint, RH_wrist_roll")
            ...
            self.get_logger().info("Controlled Joints: LH_pitch, LH_roll, LH_elbow_joint, LH_wrist_roll")
            self.joints = ["LH_pitch", "LH_roll", "LH_elbow_joint", "LH_wrist_roll"]
            # Topic to publish to
